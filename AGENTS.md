...
- Where a section renders an `AdminViewOnlySectionBanner`, its buttons pass
  ...
  (#2160, extended by #2168 and #2324): 261 of 311 `ViewOnlyActionButton` call
  sites now opt out — 234 covered by a banner in the SAME file, 27 by a verified
  vouching parent (22 at a JSX render site, 5 through the guided-setup shell) —
  and 50 keep the per-button reason: dialog/popover contents, leaf toolbars,
