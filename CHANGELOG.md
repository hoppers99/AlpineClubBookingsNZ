...
- **Your family page no longer hands out the email address of a parent who is
  ...
  groups, the parents the club has on file for them. Recording a parent does not
  put that parent in your family group — so the information sent to your browser
  could include the email address of someone you have no family connection with
