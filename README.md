<p align="center">
  <img src="docs/images/readme/hero-banner.png" alt="AlpineClubBookingsNZ — stylised alpine ridgeline banner" width="100%">
</p>
...
<p align="center">
  <img src="docs/images/readme/demo-booking.gif" alt="Animated demo of the member booking flow: choosing stay dates on the availability calendar, confirming the pre-selected guest, and reviewing the priced booking summary" width="90%">
</p>
...
Every feature above ships with an illustrated operator guide — 65 of them,
plus member-facing [user guides](docs/user-guide/README.md) — indexed in the
...
| | |
|---|---|
| [![Admin dashboard](docs/images/admin/admin-dashboard.png)](docs/guides/dashboard.md) *Admin dashboard* | [![Member booking wizard](docs/images/public/member-book.png)](docs/user-guide/booking-a-stay.md) *Member booking wizard* |
| [![Drag-and-drop bed allocation](docs/images/admin/admin-bed-allocation.png)](docs/guides/bed-allocation.md) *Drag-and-drop bed allocation* | [![Lobby TV display board](docs/lobby-display/mockups/screenshots/whole-lodge.png)](docs/lobby-display/README.md) *Lobby TV display board* |
| [![Reports](docs/images/admin/admin-reports.png)](docs/guides/reports.md) *Reports* | [![Public club website](docs/images/public/public-home.png)](docs/guides/page-content.md) *Public club website* |

<details>
<summary>There are 84 more captured screens — every admin page has one.</summary>

All screenshots are generated by a deterministic capture harness against
seeded demo data (`npm run docs:screenshots`, see
[`docs/images/README.md`](docs/images/README.md)) and embedded throughout the
[operator guides](docs/README.md).
</details>
...
**Adopting this for your club** is a supported, documented path:
...
3. Brand it — colours, fonts, and logo at `/admin/site-style`, no redeploy needed.
4. Toggle optional modules (kiosk, Xero, waitlist, multi-lodge, lobby displays, …) under **Admin → Modules**.
...
Signed-off deploys ship from GHCR images (`alpineclubbookingsnz-app`,
...
- Questions and help: [`SUPPORT.md`](SUPPORT.md) · conduct: [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md)
