- **The security and privacy contracts for the planned AI Diagnostics assistant
  ...
  a documentation hub, seven architecture decision records, and a STRIDE threat
  ...
  spend budget and rate limits, the deployment/fork contract, and a
  least-privilege read-only database credential. These contracts bind the
