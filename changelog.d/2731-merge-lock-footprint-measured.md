...
- Corrected the multi-lodge notes, which stated the club runs two lodges when it
  ...
  stale claim; it now carries the measured figures instead, and says plainly
  that how many lodges exist is a per-deployment fact rather than a property of
  the software. No behaviour changes.
