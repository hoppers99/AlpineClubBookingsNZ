...
figures rather than trusting a hand count: **85 components render a banner, and
274 of the 327 `ViewOnlyActionButton` call sites opt out** of the per-button
...
covers them: **240** pass the literal
