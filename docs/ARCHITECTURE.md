...
247 of the 290 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 247 split by WHICH rule
covers them: **221** pass the literal
