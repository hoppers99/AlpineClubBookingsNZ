...
flowchart TD
    ...
    Leader --> Q3h["Every 3 h<br/>additional-payment-reminders, confirm-pending,<br/>pre-arrival-reminders, purge-booking-requests,<br/>quote-expiry-reminders, school-attendee-confirmations,<br/>group-settlement-reaper,<br/>policy-exception-hold-reaper"]
