...
236 of the 270 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 236 split by WHICH rule
covers them: **215** pass the literal
