...
244 of the 287 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 244 split by WHICH rule
covers them: **218** pass the literal
