...
290 of the 343 `ViewOnlyActionButton` call sites opt out** of the per-button
...
test currently pins, which is the only authority.) Those 290 split by WHICH rule
covers them: **256** pass the literal
