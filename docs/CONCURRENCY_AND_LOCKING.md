...
| **Member lifecycle** | `hashtext("member-lifecycle:<memberId>")` | inline (`member-lifecycle-actions.ts`, `member-merge.ts`) | — | Archive/delete of one member, and **member merge** (dual-lock, see below). |
