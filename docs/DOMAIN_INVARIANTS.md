...
| `INV-MOD-025` | An in-progress edit prices the nights a guest holds, not their envelope, and sells only the nights it creates; ordinary stays are unchanged and history is not repriced |
