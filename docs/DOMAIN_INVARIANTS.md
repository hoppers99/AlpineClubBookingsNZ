...
| `INV-MOD-025` | An in-progress edit prices the nights a guest holds, not their envelope, and values each at the price it was sold for; contiguous stays are unchanged and history is not repriced |
