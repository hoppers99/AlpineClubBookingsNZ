...
2026) — and #2773 (owner decision 11 Aug 2026) routed the SIBLING handler for a
...
that refund reaches no card and is named only at WARN — the carve-out the owner
chose to keep (#2774 D1). And if the record write itself fails the handler still
