...
| Admin review | Review applications, cancellations, bookings, refunds | Open admin queues, inspect evidence, refresh/replace pending nominators, approve/reject | Show blockers, irreversible effects, audit trail, next queue item | Empty queue, stale pending, exhausted nomination reminders, provider failure | `/admin/dashboard`, relevant queue pages |
