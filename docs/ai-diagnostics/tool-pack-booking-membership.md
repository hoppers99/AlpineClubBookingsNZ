...
- **The audit category is optional, so an empty audit result is not evidence that
  ...
  it counts **435 row-producing production audit write sites**, and **zero** of
