...
5. **Pair the TV** — open the display URL on the screen, type the six-character
   ...
   picked, and arms the pairing in one go.
...
| The "Done" step won't tick although the screen is paired | The TV has not fetched its board yet — pairing alone is only the admin half | Leave the TV on the display page for a minute; if it never ticks, the screen has no route to the server |
