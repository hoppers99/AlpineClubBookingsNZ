...
1. Go to **Admin → Finance → Refunds & Credits**. Filter by **Pending** (the
   ...
   Appeals** and **Manual Credit Approvals**. **Reset** restores Pending and
   page 1 while preserving unrelated URL context.
...
| Reset | Restore Pending and page 1 | Always visible; disabled at defaults; preserves unrelated URL context |
