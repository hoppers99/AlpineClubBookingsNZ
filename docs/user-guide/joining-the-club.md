...
1. Go to **Log In** (`/login`) and sign in with your email and the password you
   ...
   ![The member sign-in page showing email and password fields, a Forgot password link, and links to apply for membership or request a school group booking](../images/public/public-login.png)
