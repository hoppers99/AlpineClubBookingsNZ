 ...
 * invalidates its dependents (pinned below), so `seasons-rates` and `stripe` go
 * stale while the deferral itself buys `age-tiers` passage — leaving the stale pair as
