...
const ADMIN_HELP_QUESTIONS: Record<string, HelpQuestion[]> = {
  ...
  "/admin/bed-allocation": [
    ...
    },
    {
      ...
      a: "No. Dragging an existing allocation chooses another bed only and keeps its original NZ lodge night, even when you hover over a different date column. Before anything moves, choose this allocation night or every existing allocation night for this person on the booking, including off-screen nights, then review the exact changed and unchanged rows. An all-noop confirmation writes no audit entry.",
    },
    {
